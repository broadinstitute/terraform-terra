...
module "load-balanced-instances" {
  source        = "github.com/broadinstitute/terraform-shared.git//terraform-modules/internal-load-balanced-instances?ref=internal-load-balanced-instances-0.1.4-tf-0.12"
  providers = {
