# Docker instance(s)
module "instances" {
  source        = "github.com/broadinstitute/terraform-shared.git//terraform-modules/docker-instance-data-disk?ref=docker-instance-0.1.3"
  ...
  instance_labels = {
    ...
    "owner" = "${var.owner}",
    "role" = "frontend",
    "ansible_branch" = "hackathon-pagerduty-alerts",
